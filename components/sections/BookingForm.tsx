...
// Shared input className builder — matches ContactForm
    ...
    return (
      <div className="flex flex-col items-center justify-center text-center min-h-[400px] py-8">
        ...
        <p className="text-brand-charcoal/70 mb-8 max-w-sm leading-relaxed">
          Check your email for a confirmation. Our team will reach out within
          24 hours to confirm your discovery call time.
        </p>
        <button
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5" noValidate>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div>
          ...
          />
          {errors.organization && (
            <p className="text-red-500 text-xs mt-1.5">{errors.organization.message}</p>
          )}
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div>
          ...
          {errors.service_interest && (
            <p className="text-red-500 text-xs mt-1.5">{errors.service_interest.message}</p>
          )}
        </div>
      </div>
      ...
      {/* Challenge */}
      <div>
        <label className={labelClass}>What challenge are you trying to solve? *</label>
        <textarea
          {...register('challenge')}
          rows={4}
        ...
        />
        {errors.challenge && (
          <p className="text-red-500 text-xs mt-1.5">{errors.challenge.message}</p>
        )}
      </div>
