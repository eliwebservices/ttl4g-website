...
const faqs = [
  {
    ...
    a: "Our discovery calls are free 30-minute sessions where we learn about your organization's leadership challenges, team dynamics, and goals. We'll ask targeted questions and share initial recommendations.",
  },
  {
    q: "How are your programs priced?",
    a: "Our pricing is tailored to each engagement based on scope, team size, duration, and delivery format. We offer everything from half-day workshops to extended transformational programs. After your discovery call, we provide a detailed proposal with transparent pricing.",
  },
  // {
  ...
  // },
  {
    ...
    a: "Absolutely. Every program we deliver is tailored to your organization's unique culture, challenges, and strategic objectives.",
  },
]
