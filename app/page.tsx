      ...
      <section className="relative bg-brand-bg">
        ...
        <div className="container mx-auto px-4 lg:px-16 pt-10 lg:pt-16 pb-0 relative">
          ...
          <div className="relative">
            ...
            <div
              className="
              relative lg:absolute lg:bottom-5
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
      ...
      <div className="relative w-full max-w-md lg:max-w-none mx-auto lg:mx-0">
        ...
        <div className="relative w-full aspect-[4/5] overflow-hidden">
          <Image
            ...
            alt="A cross-cultural leadership training session in action"
            fill
      ...
      <div>
        ...
        <h2 className="font-serif text-3xl lg:text-4xl font-bold text-brand-navy leading-tight mb-6">
          Practical skills for the moments that matter most.
        </h2>

        <p className="text-brand-charcoal/70 leading-relaxed mb-8">
          Our programmes are built on real corporate experience — not theory.
          From cross-cultural leadership to strategic decision-making in an
          AI-powered world, every session gives leaders the tools they need
        ...
        <div className="border-l-2 border-brand-gold pl-6 mb-10">
          ...
          <p className="text-brand-charcoal/80 leading-relaxed">
            Leadership development is not an event — it is a journey.
            Organisations that treat it as such consistently outperform
            those that don&apos;t.
          </p>
